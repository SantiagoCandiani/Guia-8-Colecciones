 ...
 */
package ejercicio.pkg03.g.pkg8;
...
public class Ejercicio03G8 {
    ...
    public static void main(String[] args) {
        ...
        ServicioAlumnos servAlum = new ServicioAlumnos();

        servAlum.crearAlumno();

        System.out.println("la nota final es :" + servAlum.notaFinal());
